...
| 17 | **Bekannt:** Social-Media-Symbole in der Fußzeile führen auf die Konten **von Wix** (`SEITE-dozenten.md`, Abschnitt 1); FAQ-Link in der Fußzeile ist tot (erledigt 26.09.2026: neue Seite „Häufige Fragen“ mit Weiterleitung, `SEITE-faq.md`). Auf den Rechtstext-Seiten besonders unglücklich, weil die Datenschutzerklärung Facebook und Instagram beschreibt. | Fußzeile | nur Verweis |
